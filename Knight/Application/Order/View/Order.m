...
//  Knight
//
//  Created by QiuHao on 2019/4/11.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.successLabel.text = [NSString stringWithFormat: @"完成时间：%@", [date stringFromDate: [[self.dataAry objectAtIndex: indexPath.row] objectForKey: @"updatedAt"]]];
    
    [cell reloadLayout: LIST_TYPE_DONE_TASK];
